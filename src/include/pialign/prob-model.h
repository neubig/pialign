...
protected:
    ...
    // the current sentences and their lengths
    WordString e_, f_;
    int eLen_, fLen_;
    int maxLen_;
...
public:
    ...
    virtual void addBase(WordId jId, const Span & mySpan, Prob) = 0;

    // add a count to the model that was generated by splitting into two trees
    virtual void addTree(WordId jId,WordId lId,WordId rId,const Span & jSpan,const Span & lSpan, const Span & rSpan, int type, Prob) = 0;
    ...
    virtual void initialize(const WordString & e, const WordString & f, 
